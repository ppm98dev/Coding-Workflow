...
**Rationale**: GSD has session persistence, execution loops, and debugging that Spec-Kit lacks. Spec-Kit has formal governance (constitution, forced clarification, test-first) that Quantis needs.
