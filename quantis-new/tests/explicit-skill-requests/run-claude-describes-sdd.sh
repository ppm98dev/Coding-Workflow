...
# Create a plan
cat > "$PROJECT_DIR/.quantis/phases/{N}/auth-system.md" << 'EOF'
...
claude -p "I have a plan at .quantis/phases/{N}/auth-system.md. Tell me about my options for executing it, including what subagent-driven-development means and how it works." \
    --model haiku \
