...
cat > .quantis/phases/{N}/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at .quantis/phases/{N}/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at .quantis/phases/{N}/implementation-plan.md using the subagent-driven-development skill.
