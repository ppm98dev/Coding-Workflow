...
**Personal skills live in agent-specific directories (e.g. `~/.agents/skills/`)** 
...
- Project-specific conventions (put in your platform's config, e.g. GEMINI.md)
...
**IMPORTANT: Use task tracking to track for EACH checklist item below.**
